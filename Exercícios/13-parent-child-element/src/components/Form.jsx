...
class Form extends Component {
  ...
  handleError() {
    ...
    // formularioPreenchido estará com false
    const formularioPreenchido = errorCases.every(
      (error) => error !== true);

    this.setState({
      // Armazenamos o valor inverso no nosso estado
      // para saber se o formulário possui erros
  ...
  handleChange({ target }) {
    ...
    this.setState({
      [name]: value,
      // Após alterarmor o estado, chamamos a função
      // que irá verificar os erros.
    }, this.handleError);
  }
